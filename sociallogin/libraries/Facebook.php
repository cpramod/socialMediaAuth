...
class Facebook {
    ...
    */
    ...
    public function __construct() {
        ...
        if($this->CI->config->item('redirect_uri') === '' ) {
            $this->my_url = site_url('');
        } else {
            $this->my_url = $this->CI->config->item('redirect_uri');
        }
